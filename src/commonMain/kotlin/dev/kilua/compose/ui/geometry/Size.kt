...
import dev.kilua.compose.ui.util.lerp
import dev.kilua.compose.ui.util.packFloats
import dev.kilua.compose.ui.util.unpackAbsFloat1
import dev.kilua.compose.ui.util.unpackAbsFloat2
import dev.kilua.compose.ui.util.unpackFloat1
import dev.kilua.compose.ui.util.unpackFloat2
...
@Stable
fun Size.toRect(): Rect = Rect(Offset.Zero, this)
